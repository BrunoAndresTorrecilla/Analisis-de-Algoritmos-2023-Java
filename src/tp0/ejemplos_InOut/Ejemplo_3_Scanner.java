...
public class Ejemplo_3_Scanner {
    ...
    static final String NOMBRE_ARCHIVO = "src/tp0/input_files/numeros.txt";
    ...
    private static void leerArchivo_2(){
    	try{
    		BufferedReader buff = new BufferedReader(new FileReader("src/tp0/input_files/ejemplo_scanner"));
    		Scanner s = new Scanner(buff);
